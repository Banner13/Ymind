...
#####代理设置及查看
	...
	function proxy_on() {
			...
			export http_proxy="socks5://192.168.3.63:10808" #注意，根据自己的配置设置有可能会是1080或1086
			...
			export FTP_PROXY=$http_proxy
			export RSYNC_PROXY=$http_proxy
			git config --global http.proxy "socks5://192.168.3.63:10808"
			git config --global https.proxy "socks5://192.168.3.63:10808"
			echo -e "已开启代理"
			curl cip.cc
	}
	curl cip.cc
